...
description: >
  ...
  Usage: $sf-hcls-solutions:clinical-quality-agent | $sf-hcls-solutions:clinical-quality-agent teardown
...
Read and present the content from `NEXT_ACTIONS.md` in `solutions/clinical-quality-agent/`.
...
```
Usage:
  $sf-hcls-solutions:clinical-quality-agent           — Install the solution
