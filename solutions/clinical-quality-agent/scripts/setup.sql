...
-- ============================================================
-- Section 3: Semantic Model Stage
-- ============================================================
...
-- NOTE: Upload of semantic_model.yaml and CREATE AGENT are handled by
-- deploy_agent.sql, which is executed by the installer after PUT succeeds.
