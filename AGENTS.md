...
This is the `sf-hcls-solutions` repository containing Snowflake HCLS (Healthcare & Life Sciences) industry solution accelerators. Each solution lives in `solutions/<name>/` with a standard structure (manifest.json, scripts/, streamlit/).
