...
description: >
  ...
  "$sf-hcls-solutions:list", "what snowflake solutions exist".
tools:
  - Read
  - Glob
---
...
| Invocation | Action |
|---|---|
| `$sf-hcls-solutions:list` | Present full auto-discovered catalog |
| `$sf-hcls-solutions:list <industry>` | Filter by industry |
| `$sf-hcls-solutions:list <tag>` | Filter by tag |
...
To add the first solution:
  $sf-hcls-solutions:add-solution
```
...
To install a solution:
  $sf-hcls-solutions:<slug>
  $sf-hcls-solutions:<slug> teardown
  $sf-hcls-solutions:<slug> next
...
| Skill | Purpose |
|-------|---------|
| solutions-scaffold | Shared engineering conventions for building sf-hcls-solutions skills |
